...
class ReportHelper {
  ...
  public static function getExpensesByAccount(int $teamId, $startDate = null, $endDate = null, $groupBy = "display_id", $accounts = ['expenses']) {
  ...
  public static function getTransactionsByCategory(int $teamId, array $accounts, $startDate = null, $endDate = null, $transactionableType = null) {
    $endDate = $endDate ?? Carbon::now()->endOfMonth()->format('Y-m-d');
    $startDate = $startDate ?? Carbon::now()->startOfMonth()->format('Y-m-d');
